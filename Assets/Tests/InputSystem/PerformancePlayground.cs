...
internal class PerformancePlayground : InputTestFixture
{
    ...
    public void Dmytro_RND()
    {
        ...
        // profiler.selectedFrameIndex = profiler.lastAvailableFrameIndex - 2;
        // var cpuModule = profiler.GetFrameTimeViewSampleSelectionController(ProfilerWindow.cpuModuleName);
        // cpuModule.SetSelection("PerfTest no3");
